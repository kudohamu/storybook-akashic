...
import { StoryFnAkashicReturnType, IStorybookSection } from './types';

const framework = 'akashic';

interface ClientApi extends ClientStoryApi<StoryFnAkashicReturnType> {
